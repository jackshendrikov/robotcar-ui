...
var UMC = UMC || function() {
    ...
    UMC.dom = function(b, c, k, h, f, m) {
        ...
        b && ("UIL" === b ? k = "-o-user-select:none; -ms-user-select:none; -khtml-user-select:none; -webkit-user-select:none; -moz-user-select:none;position:absolute; pointer-events:none; box-sizing:border-box; margin:0; padding:0; border:none; overflow:hidden; background:none;" + k : "UIL text" === b ? k = '-o-user-select:none; -ms-user-select:none; -khtml-user-select:none; -webkit-user-select:none; -moz-user-select:none;position:absolute; pointer-events:none; box-sizing:border-box; margin:0; padding:0; border:none; overflow:hidden; background:none;font-family:"Lucida Console", Monaco, monospace; font-size:11px; color:#CCC; padding:2px 10px; left:0; top:2px; height:16px; width:100px; overflow:hidden; white-space: nowrap;' +
            ...
            k : f.setAttribute("class", b));
        k && (f.style.cssText = k);
        return void 0 === m ? f : f.childNodes[m || 0]
    };
    UMC.cc = function(c, d, e) {
        ...
        f.type = "text/css";
        b.appendChild(f);
        (f.sheet || {}).insertRule ? f.sheet.insertRule(e + c + "{" + d + "}", 0) : (f.styleSheet || f.sheet).addRule(e + c, d)
    };
    ...
    UMC.add = function(a, b, c, d) {
        ...
        this.get(a, d).appendChild(f); -
            1 !== e.indexOf(b) && (f.style.pointerEvents = "none");
        return f
    };
    ...
    UMC.toCanvas = function(a, b, c, d) {
        var e = a.getContext("2d");
        a = null;
        "string" === typeof b ? (a = UMC.dom(null, "iframe",
            "position:abolute; left:0; top:0; width:" + c + "px; height:" + d + "px;"), a.src = b) : (a = b.cloneNode(!0), a.style.left = 0);
        b = UMC.dom(null, "foreignObject", "position:abolute; left:0; top:0;", {
            width: c,
            height: d
        });
        b.childNodes[0].appendChild(a);
        b.setAttribute("version", "5.5");
        ...
        b.childNodes[0].setAttribute("width", "100%");
        b.childNodes[0].setAttribute("height",
            "100%");
        b = "data:image/svg+xml;base64," + window.btoa((new XMLSerializer).serializeToString(b));
        a = null;
        f.src = b;
        setTimeout(function() {
            e.clearRect(0, 0, c, d);
            e.drawImage(f, 0, 0, c, d, 0, 0, c, d)
        }, 0)
    };
    return UMC
}();
...
UIL.Gui = function(a) {
    ...
    this.bg = a.bg || "rgba(44,44,44,0.3)";
    this.isCenter = a.center || !1;
    this.onWheel = this.lockwheel = !1;
    this.isOpen = !0;
    this.height = a.height || UIL.HEIGHT;
    this.uis = [];
    this.content = UIL.DOM("UIL", "div", "display:block; width:300px; height:auto; top:0; right:10px; transition:height 0.1s ease-out;" +
        a.css);
    ...
    this.content.addEventListener("mouseup", this, !1);
    this.content.addEventListener("mouseover", this, !1);
    document.addEventListener("mousewheel", this, !1);
    window.addEventListener("resize", function(a) {
        this.resize(a)
    }.bind(this), !1);
    this.setWidth(a.size ||
        240)
};
UIL.Gui.prototype = {
    constructor: UIL.Gui,
    hide: function(a) {
        this.content.style.display = a ? "none" : "block"
    },
    setBG: function(a) {
        this.bg = a;
        for (var b = this.uis.length; b--;) this.uis[b].setBG(a);
        this.bottom.style.background = a
    },
    getHTML: function() {
        return this.content
    },
    ...
    down: function(a) {
        a.target.name && ("scroll" === a.target.name && (this.isDown = !0, this.move(a), document.addEventListener("mouseup", this, !1), document.addEventListener("mousemove", this, !1)), "bottom" === a.target.name && (this.isOpen = this.isOpen ? !1 : !0, this.show()))
    },
    move: function(a) {
    ...
    over: function(a) {
        a.target.name && "scroll" === a.target.name && (this.scroll.style.background = "#888")
    },
    wheel: function(a) {
        a.preventDefault();
        a.stopPropagation();
        if (!this.lockwheel && this.isScroll) {
            ...
            b < c || b > c + this.width || (b = 0, a.wheelDeltaY ? b = 0.04 * -a.wheelDeltaY : a.wheelDelta ? b = 0.2 * -a.wheelDelta : a.detail && (b = 4 * a.detail),
                this.py += b, this.update(this.py))
        }
    },
    add: function() {
        var a = arguments;
        "object" === typeof a[1] ? (a[1].isUI = !0, a[1].main = this) : "string" === typeof a[1] && (void 0 === a[2] ? [].push.call(a, {
            isUI: !0,
            main: this
        }) : (a[2].isUI = !0, a[2].main = this));
        a = UIL.add.apply(this, a);
        this.uis.push(a);
        if (a.autoWidth) this.prevY = -1, this.calc(a.h + 1);
        else {
    ...
    remove: function(a) {
        a = this.uis.indexOf(a); - 1 !== a && (this.uis[a].clear(), this.uis.splice(a,
            1))
    },
    clear: function() {
        this.update(0);
...
UIL.Proto = function(a) {
    ...
    this.autoHeight = !1;
    this.isUI = a.isUI || !1;
    this.isEdit = this.mono = this.isNumber = !1;
    ...
    this.isSend = !1;
    var b = 20;
    this.isUI && (b = UIL.HEIGHT);
    this.h = a.h || a.height || b;
    this.h = 11 > this.h ? 11 : this.h;
    this.bgcolor = UIL.COLOR ||
        a.bgcolor;
    this.bg = this.isUI ? this.main.bg : "rgba(44,44,44,0.3)";
    void 0 !== a.bg && (this.bg = a.bg);
    this.titleColor = a.titleColor || UIL.BASECOLOR;
    this.fontColor = a.fontColor || UIL.BASECOLOR;
    this.colorPlus = UIL.ColorLuma(this.fontColor, 0.3);
    this.txt = a.name || "Proto";
    this.rename = a.rename || "";
    this.target = a.target || null;
    this.callback = void 0 === a.callback ? null : a.callback;
    this.endCallback = null;
    null === this.callback && this.isUI && null !== this.main.callback && (this.callback = this.main.callback);
    this.c = [];
    this.s = [];
    this.c[0] =
        UIL.DOM(null, "div", UIL.BASIC + "position:relative; height:20px; float:left;");
    this.s[0] = this.c[0].style;
    this.isUI && (this.s[0].marginBottom = "1px");
    this.simple || (this.c[1] = UIL.DOM(null, "div", UIL.BASIC + UIL.TXT), this.s[1] = this.c[1].style, this.c[1].textContent = "" === this.rename ? this.txt : this.rename, this.s[1].color = this.titleColor);
    if (a.pos) {
...
UIL.Proto.prototype = {
    ...
    init: function() {
        ...
        this.isUI && (this.s[0].background = this.bg);
        ...
        null !== this.target ? this.target.appendChild(this.c[0]) : this.isUI ? this.main.inner.appendChild(this.c[0]) :
            document.body.appendChild(this.c[0]);
    ...
    listening: function() {
        null !== this.parent && (this.isSend || this.isEdit || this.setValue(this.parent[this.val]))
    },
    setValue: function(a) {
    ...
    clear: function() {
        this.clearEvent();
        UIL.clear(this.c[0]);
        null !== this.target ? this.target.removeChild(this.c[0]) : this.isUI ? this.main.inner.removeChild(this.c[0]) : document.body.removeChild(this.c[0]);
...
UIL.Group = function(a) {
    ...
    a.line && (this.c[5] = UIL.DOM("UIL", "div",
        "background:" + this.fontColor + "; width:100%; left:0; height:1px; bottom:0px"));
    var b = this.s;
    b[0].height = this.h + "px";
    b[1].height = this.h + "px";
    b[1].top = "4px";
    b[1].left = "4px";
    b[1].pointerEvents = "auto";
    b[1].cursor = "pointer";
    this.c[1].name = "group";
...
UIL.Group.prototype.open = function() {
    ...
    this.rSizeContent();
    this.isUI && this.main.calc(this.h - this.baseH)
};
...
UIL.Group.prototype.clear = function() {
    this.clearGroup();
    this.isUI && this.main.calc(-(this.h + 1));
...
UIL.Group.prototype.calc = function(a) {
    this.isOpen && (void 0 !== a ? (this.h += a, this.isUI && this.main.calc(a)) : this.h = this.c[2].offsetHeight + this.baseH, this.s[0].height = this.h + "px")
};
...
UIL.Color.prototype.show = function() {
    ...
    null !== this.parentGroup ? this.parentGroup.calc(this.h -
        this.baseH) : this.isUI && this.main.calc(this.h - this.baseH)
};
UIL.Color.prototype.hide = function() {
    null !== this.parentGroup ? this.parentGroup.calc(-(this.h - this.baseH)) : this.isUI && this.main.calc(-(this.h - this.baseH));
    this.isShow = !1;
    this.h = this.baseH;
...
UIL.Color.prototype.update = function(a) {
    ...
    a && ("array" === this.ctype && this.send(this.rgb), "rgb" === this.ctype && this.send(UIL.htmlRgb(this.rgb)), "hex" === this.ctype && this.send(UIL.htmlToHex(this.value)), "html" === this.ctype && this.send())
};
...
UIL.Color.prototype.calculateMask = function(a, b, c) {
    for (var d = 1 / a, e = 1 / b, f = 0; f <= b; ++f)
        for (var h = 1 - f * e, g = 0; g <= a; ++g) {
            var l = 1 - g * d,
                l = 1 - 2 * Math.min(h * l, (1 - h) * l);
            c(g, f, 0 < l ? 0.5 * (2 * h - 1 + l) / l : 0, l)
        }
};
...
UIL.Color.prototype.rSize = function() {
    ...
    this.ctxMask.translate(this.mid, this.mid);
    this.ctxOverlay.translate(this.mid, this.mid);
    this.isShow && (this.redraw(), this.h = this.width + 30, this.c[0].height = this.h + "px", this.isUI && this.main.calc())
};
UIL.Slide = function(a) {
    UIL.Proto.call(this, a);
    this.setTypeNumber(a);
    this.stype = a.stype || 0;
    this.buttonColor = a.bColor || UIL.BUTTON;
    ...
    this.c[4] = UIL.DOM("UIL", "div", "border:1px solid " + UIL.Border + "; pointer-events:none; background:rgba(0,0,0,0.3); top:2px; height:" +
        (this.h - 4) + "px;");
    this.c[5] = UIL.DOM("UIL", "div", "left:4px; top:5px; height:" + (this.h - 10) + "px; background:" + this.fontColor + ";");
    this.c[2].name = "text";
    this.c[3].name = "scroll";
    if (0 !== this.stype) {
        if (1 === this.stype || 3 === this.stype) var b = 4,
            c = 8,
            d = this.h - 4,
            e = 20;
        2 === this.stype && (b = 2, c = 4, e = 2, d = 0.5 * (this.h - 4));
        3 === this.stype && (this.c[5].style.visible = "none");
        this.c[4].style.borderRadius = b + "px";
        this.c[4].style.height = c + "px";
        this.c[4].style.top = 0.5 * this.h - b + "px";
        this.c[5].style.borderRadius = 0.5 * b + "px";
        this.c[5].style.height =
            b + "px";
        this.c[5].style.top = 0.5 * this.h - 0.5 * b + "px";
        this.c[6] = UIL.DOM("UIL", "div", "border-radius:" + e + "px; margin-left:" + 0.5 * -d + "px; border:1px solid " + UIL.Border + "; background:" + this.buttonColor + "; left:4px; top:2px; height:" + (this.h - 4) + "px; width:" + d + "px;")
    }
...
UIL.Slide.prototype.handleEvent = function(a) {
    switch (a.type) {
        case "mouseover":
            ...
            break;
        case "mousedown":
            "text" === a.target.name ? this.textdown(a) : this.down(a);
            break;
        case "mouseout":
            this.out(a);
            break;
...
UIL.Slide.prototype.mode = function(a) {
    ...
    switch (a) {
        case 0:
            ...
            b[4].background = "rgba(0,0,0,0.3)";
            b[5].background = this.fontColor;
            break;
        case 1:
            b[2].color = this.colorPlus, b[4].background = b[6] ? "rgba(0,0,0,0.6)" : UIL.SlideBG, b[5].background = this.colorPlus
    }
};
...
UIL.Slide.prototype.move = function(a) {
    a = (a.clientX - this.left - 3) / this.w * this.range + this.min - this.old;
    if (a >= this.step || a <= this.step) a = ~~(a / this.step), this.value = this.numValue(this.old + a * this.step), this.update(!0), this.old = this.value
};
UIL.Slide.prototype.update = function(a) {
    var b = (this.value - this.min) / this.range * this.w;
    3 !== this.stype && (this.s[5].width = ~~b + "px");
    this.s[6] && (this.s[6].left = ~~(this.sa + b + 3) + "px");
    this.c[2].textContent = this.value;
    a && this.send()
};
UIL.Slide.prototype.rSize = function() {
    ...
    var b = ~~(0.5 * this.h) - 8,
        c = this.s;
    c[2].width = this.sc - 2 + "px";
    c[2].left = this.size - a + 2 + "px";
    c[2].top = b + "px";
    c[3].left = this.sa + "px";
    c[3].width = this.width + "px";
    c[4].left = this.sa + "px";
    c[4].width = this.width + "px";
    c[5].left = this.sa + 3 + "px";
    this.update()
};
UIL.Slide.prototype.validate = function(a) {
    isNaN(this.c[2].textContent) ? this.c[2].textContent = this.value : (this.value = this.numValue(this.c[2].textContent), this.update(!0))
};
UIL.Slide.prototype.textdown = function(a) {
    a.target.contentEditable = !0;
    a.target.focus();
    this.isEdit = !0
};
UIL.Slide.prototype.keydown = function(a) {
    a.stopPropagation();
    13 === a.keyCode && (a.preventDefault(), this.validate(), a.target.blur())
};
UIL.Slide.prototype.keyup = function(a) {
    a.stopPropagation();
    this.allway && this.validate()
};
UIL.Slide.prototype.blur = function(a) {
    a.target.style.border = "none";
    this.isEdit = a.target.contentEditable = !1
};
UIL.Slide.prototype.focus = function(a) {
    a.target.style.border = "1px dashed " + UIL.BorderSelect
};
UIL.List = function(a) {
    UIL.Proto.call(this, a);
    this.autoHeight = !0;
    ...
    this.c[4] = UIL.DOM("UIL",
        "div", "position:absolute; width:10px; height:10px; left:" + (this.sa + this.sb - 5) + "px; top:" + (~~(0.5 * this.h) - 5) + "px; background:" + UIL.F0);
    ...
    this.side = a.side || "down";
    this.holdTop = 0;
    "up" === this.side && (this.c[2].style.top = "auto", this.c[3].style.top = "auto", this.c[4].style.top = "auto", this.c[5].style.top = "auto", this.c[2].style.bottom = "10px", this.c[3].style.bottom = "2px", this.c[4].style.bottom = "2px", this.c[5].style.bottom =
        "2px");
    this.max > this.maxHeight && (this.w = this.sb - 20, this.scroll = !0);
...
UIL.List.prototype.mode = function(a) {
    ...
    switch (a) {
        case 0:
            ...
            b[3].background = this.buttonColor;
            break;
        case 1:
            b[5].color = "#FFF";
...
UIL.List.prototype.listShow = function() {
    ...
    this.rSizeContent();
    null !== this.parentGroup ? this.parentGroup.calc(this.h - this.baseH) : this.isUI &&
...
UIL.Bool = function(a) {
    ...
    this.buttonColor = UIL.BUTTON;
    this.inh = a.inh || this.h;
    a = ~~(0.5 * this.h) - 0.5 * (this.inh - 2);
    this.c[2] = UIL.DOM("UIL", "div", "background:" + UIL.BOOLBG + "; height:" + (this.inh - 2) + "px; width:36px; top:" + a + "px; border-radius:20px; pointer-events:auto; cursor:pointer; transition:0.1s ease-out;");
    this.c[3] = UIL.DOM("UIL", "div", "opasity:0, background:" + UIL.BOOLBG + "; height:" + (this.inh - 6) + "px; width:" + (this.inh - 6) + "px; top:" + (a + 2) + "px; border-radius:20px; ");
    this.c[4] = UIL.DOM("UIL", "div", "border:1px solid " + UIL.Border + "; height:" + (this.inh - 4) + "px; width:16px; top:" + (a + 1) + "px; border-radius:20px; background:" + this.buttonColor + "; transition:margin 0.1s ease-out;");
...
UIL.Bool.prototype.update = function() {
    var a = this.s;
    this.value ? (a[4].marginLeft = "18px", a[2].background = this.fontColor, a[2].borderColor = this.fontColor, a[4].borderColor = this.fontColor) : (a[4].marginLeft = "0px", a[2].background = UIL.BOOLBG, a[2].borderColor = UIL.BOOLBG, a[4].borderColor = UIL.Border)
};
UIL.Button = function(a) {
    UIL.Proto.call(this, a);
    this.value = a.value || !1;
    this.buttonColor = a.bColor || UIL.BUTTON;
    this.isLoadButton = a.loader || !1;
    this.isDragButton = a.drag || !1;
    this.r = a.r || 0;
    ...
    this.isLoadButton && this.initLoader();
    this.isDragButton && this.initDrager();
    this.init()
};
...
UIL.Button.prototype.handleEvent = function(a) {
    ...
    switch (a.type) {
        ...
        case "mouseout":
            ...
            break;
        case "change":
            this.fileSelect(a.target.files[0]);
            break;
        case "dragover":
            this.dragover();
            break;
...
UIL.Button.prototype.drop = function(a) {
    this.dragend();
    this.fileSelect(a.dataTransfer.files[0])
};
UIL.Button.prototype.mode = function(a) {
    ...
    switch (a) {
        case 0:
            ...
            b[2].background = this.buttonColor;
            break;
        case 1:
            b[3].color = "#FFF";
...
UIL.Button.prototype.fileSelect = function(a) {
    this.c[4].type = "null";
    if (void 0 !== a) {
        var b = new FileReader,
            c = a.name,
            d = c.substring(c.indexOf(".") + 1, c.length);
        "png" === d || "jpg" === d ? b.readAsDataURL(a) : "z" === d ? b.readAsBinaryString(a) : b.readAsText(a);
        b.onload = function(a) {
            this.callback(a.target.result, c, d);
            this.c[4].type = "file"
        }.bind(this)
    }
};
...
UIL.Button.prototype.rSize = function() {
    ...
    var a = this.s,
        b = this.sb,
        c = this.sa;
    this.isDragButton && (b = 0.5 * b - 5, a[5].left = c + b + 5 + "px", a[5].width = b + "px");
    a[2].left = c + "px";
    a[2].width = b + "px";
    a[3].left = c + "px";
    a[3].width = b + "px";
    a[4] && (a[4].left = c + "px", a[4].width = b + "px")
};
UIL.Circular = function(a) {
    ...
    this.percent = 0;
    this.c[2] =
        UIL.DOM("UIL number", "div", "text-align:center; top:" + (this.height + 24) + "px; width:" + this.size + "px; color:" + this.fontColor);
    ...
    this.c[5] =
        UIL.DOM("UIL", "circle", "left:10px; top:" + this.top + "px; width:" + this.w + "px; height:" + this.height + "px;", {
            cx: this.radius,
            cy: this.radius,
            r: 0.5 * this.radius,
...
UIL.Knob = function(a) {
    ...
    this.top = 0;
    this.c[0].style.width = this.size + "px";
    void 0 !== this.c[1] && (this.c[1].style.width = this.size + "px", this.c[1].style.textAlign = "center",
        this.top = 20);
    this.percent = 0;
...
UIL.Knob.prototype.makeGrad = function() {
    var a = "",
        ...
        l = Math.PI + this.mPI;
    b = Math.PI - this.mPI;
    5 < this.step ? (c = this.range / this.step, b = (l - b) / c) : (b = (l - b) / g, c = g);
    for (var k = 0; k <= c; ++k) d = l - b * k, e = g + Math.sin(d) * g, f = g + Math.cos(d) * g, h = g + Math.sin(d) * (g - 3), d = g + Math.cos(d) * (g - 3), a += "M" + e + " " + f + " L" + h + " " + d + " ";
    return a
};
